...
return [
    ...
    'defaults' => [
            ...
            'securitySchemes' => [
                ...
                */
                ...
                'bearerAuth' => [
                    ...
                    'description' => 'Sanctum token authorization.',
                    'scheme'      => 'bearer',
                    'in'          => 'header', // The location of the API key. Valid values are "query" or "header".
                ],
            ],
        ...
        */
         ...
         */
         'constants' => [
            'L5_SWAGGER_CONST_HOST' => env('L5_SWAGGER_CONST_HOST', 'http://passport.showheroes.com'),
            'L5_SWAGGER_CONST_PROD_HOST' => env('L5_SWAGGER_CONST_PROD_HOST', 'http://passport.showheroes.com'),
         ],
    ],
];
